    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={stylesCrew.crewGrid} >
          ...
          <PersonFrame src="/crew/crewmates/abdel.jpg" frameSize="39px" frameStyle="frame2" gridColStart={53} gridColEnd={62} gridRowStart={101} gridRowEnd={110}/>
          ...
          <PersonFrame src="/crew/crewmates/gersti.jpg" frameSize="19px" frameStyle="frame2" gridColStart={2} gridColEnd={15} gridRowStart={2} gridRowEnd={15}/>
          ...
          <NameTag name={'Lisa'} fieldOfStudy={'Informatik Master'} semesterNmbr={2} fontSizeTop={"150%"} fontSizeBottom={"55%"} gridColStart={52} gridColEnd={56} gridRowStart={70} gridRowEnd={74}/>
          ...
          <NameTag name={'Nala'} fieldOfStudy={'Angewandte Doggologie'} semesterNmbr={3} fontSizeTop={"260%"} fontSizeBottom={"110%"} gridColStart={60} gridColEnd={75} gridRowStart={59} gridRowEnd={65}/>
          ...
          <PersonFrame src="/crew/crewmates/pascal.jpg" frameSize="20px" frameStyle="frame2" gridColStart={15} gridColEnd={23} gridRowStart={13} gridRowEnd={21}/>
