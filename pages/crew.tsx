    ...
    <Layout>
      ...
      <div style={{maxWidth: '100%', overflowY: 'auto', overflowX: 'scroll'}}>
        <div className={stylesCrew.frameGrid}>
          ...
          <NameTag name={'Dimi'} fieldOfStudy={'Mathematik Bachelor'} semesterNmbr={15} fontSizeTop={"150%"} fontSizeBottom={"55%"} gridColStart={64} gridColEnd={74} gridRowStart={103} gridRowEnd={108}/>
          ...
          <NameTag name={'LUC'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={7} fontSizeTop={"150%"} fontSizeBottom={"50%"} gridColStart={75} gridColEnd={81} gridRowStart={120} gridRowEnd={125}/>
          ...
          <NameTag name={'Maria'} fieldOfStudy={'Ehem. Info'} semesterNmbr={0} fontSizeTop={"150%"} fontSizeBottom={"50%"} gridColStart={4} gridColEnd={13} gridRowStart={121} gridRowEnd={125}/>
          ...
          <NameTag name={'Papamat Mamagei Paul'} fieldOfStudy={'Informatik Master'} semesterNmbr={1} fontSizeTop={"200%"} fontSizeBottom={"65%"} gridColStart={30} gridColEnd={40} gridRowStart={1} gridRowEnd={8}/>
          ...
          <NameTag name={'Ville'} fieldOfStudy={'Bolizei 🚓'} semesterNmbr={0} fontSizeTop={"130%"} fontSizeBottom={"50%"} gridColStart={62} gridColEnd={69} gridRowStart={66} gridRowEnd={70}/>
