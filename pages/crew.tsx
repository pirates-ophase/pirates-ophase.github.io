    ...
    <Layout>
      ...
      <div style={{maxWidth: '100%', overflowY: 'auto', overflowX: 'scroll'}}>
        <div className={stylesCrew.frameGrid}>
          ...
          <NameTag name={'1.Maatin Zoe'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={9} fontSizeTop={"99%"} fontSizeBottom={"58%"} gridColStart={23} gridColEnd={32} gridRowStart={55} gridRowEnd={58}/>
          ...
          <NameTag name={'Papagei Tobi'} fieldOfStudy={'Informatik Master'} semesterNmbr={3} fontSizeTop={"99%"} fontSizeBottom={"50%"} gridColStart={24} gridColEnd={33} gridRowStart={105} gridRowEnd={108}/>
          ...
          <NameTag name={'Schatzmeisterin Sarah'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={9} fontSizeTop={"99%"} fontSizeBottom={"60%"} gridColStart={38} gridColEnd={49} gridRowStart={55} gridRowEnd={60}/>
          ...
          <NameTag name={'Axel'} fieldOfStudy={'Informatik Master'} semesterNmbr={2} fontSizeTop={"99%"} fontSizeBottom={"50%"} gridColStart={16} gridColEnd={22} gridRowStart={122} gridRowEnd={125}/>
          ...
          <NameTag name={'Benni'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={13} fontSizeTop={"110%"} fontSizeBottom={"60%"} gridColStart={42} gridColEnd={54} gridRowStart={85} gridRowEnd={89}/>
          ...
          <NameTag name={'Cedrico'} fieldOfStudy={'Informatik Master'} semesterNmbr={2} fontSizeTop={"150%"} fontSizeBottom={"60%"} gridColStart={58} gridColEnd={70} gridRowStart={85} gridRowEnd={90}/>
          ...
          <NameTag name={'Chloe'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={5} fontSizeTop={"120%"} fontSizeBottom={"55%"} gridColStart={24} gridColEnd={31} gridRowStart={159} gridRowEnd={163}/>
          ...
          <NameTag name={'Christian'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={7} fontSizeTop={"120%"} fontSizeBottom={"55%"} gridColStart={3} gridColEnd={12} gridRowStart={3} gridRowEnd={8}/>
          ...
          <NameTag name={'Dani'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={19} fontSizeTop={"160%"} fontSizeBottom={"55%"} gridColStart={57} gridColEnd={64} gridRowStart={96} gridRowEnd={101}/>
          ...
          <NameTag name={'Jonas'} fieldOfStudy={'Informatik Master'} semesterNmbr={5} fontSizeTop={"150%"} fontSizeBottom={"55%"} gridColStart={1} gridColEnd={10} gridRowStart={43} gridRowEnd={46}/>
          ...
          <NameTag name={'Max'} fieldOfStudy={'Informatik Master'} semesterNmbr={3} fontSizeTop={"200%"} fontSizeBottom={"100%"} gridColStart={32} gridColEnd={48} gridRowStart={137} gridRowEnd={143}/>
          <NameTag name={'Joschka'} fieldOfStudy={'Informatik Master'} semesterNmbr={1} fontSizeTop={"200%"} fontSizeBottom={"100%"} gridColStart={52} gridColEnd={70} gridRowStart={137} gridRowEnd={143}/>
          ...
          <NameTag name={'Julian'} fieldOfStudy={'Mathematik PhD'} semesterNmbr={1} fontSizeTop={"150%"} fontSizeBottom={"55%"} gridColStart={5} gridColEnd={17} gridRowStart={90} gridRowEnd={95}/>
          ...
          <NameTag name={'Lisa'} fieldOfStudy={'Informatik Master'} semesterNmbr={"3. 1"} fontSizeTop={"150%"} fontSizeBottom={"55%"} gridColStart={51} gridColEnd={58} gridRowStart={70} gridRowEnd={74}/>
          ...
          <NameTag name={'LUC'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={5} fontSizeTop={"150%"} fontSizeBottom={"50%"} gridColStart={75} gridColEnd={81} gridRowStart={120} gridRowEnd={125}/>
          ...
          <NameTag name={'Lea'} fieldOfStudy={'Informatik Master'} semesterNmbr={5} fontSizeTop={"150%"} fontSizeBottom={"50%"} gridColStart={77} gridColEnd={85} gridRowStart={56} gridRowEnd={60}/>
          ...
          <NameTag name={'Maria'} fieldOfStudy={'Informatik Master'} semesterNmbr={6} fontSizeTop={"150%"} fontSizeBottom={"50%"} gridColStart={4} gridColEnd={13} gridRowStart={121} gridRowEnd={125}/>
          ...
          <NameTag name={'Mattis'} fieldOfStudy={'Informatik Master'} semesterNmbr={2} fontSizeTop={"200%"} fontSizeBottom={"50%"} gridColStart={70} gridColEnd={78} gridRowStart={152} gridRowEnd={158}/>
          ...
          <NameTag name={'Lena'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={9} fontSizeTop={"220%"} fontSizeBottom={"90%"} gridColStart={1} gridColEnd={12} gridRowStart={22} gridRowEnd={28}/>

          <ImageFrame src="/crew/crewmates_mid_res/pascal.jpg" frameSize="20px" frameStyle="frame2" gridColStart={73} gridColEnd={83} gridRowStart={7} gridRowEnd={18}/>
          <NameTag name={'Pascal'} fieldOfStudy={'Informatik Master'} semesterNmbr={4} fontSizeTop={"110%"} fontSizeBottom={"60%"} gridColStart={79} gridColEnd={85} gridRowStart={16} gridRowEnd={19}/>
          ...
          <NameTag name={'Paul'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={7} fontSizeTop={"200%"} fontSizeBottom={"65%"} gridColStart={30} gridColEnd={40} gridRowStart={1} gridRowEnd={8}/>
          ...
          <NameTag name={'Philipp'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={9} fontSizeTop={"200%"} fontSizeBottom={"70%"} gridColStart={4} gridColEnd={12} gridRowStart={68} gridRowEnd={76}/>
          <NameTag name={'Max'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={9} fontSizeTop={"200%"} fontSizeBottom={"70%"} gridColStart={27} gridColEnd={35} gridRowStart={69} gridRowEnd={77}/>
          <NameTag name={'Algebra'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={9} fontSizeTop={"200%"} fontSizeBottom={"70%"} gridColStart={22} gridColEnd={30} gridRowStart={79} gridRowEnd={87}/>
          ...
          <NameTag name={'Saad'} fieldOfStudy={'Informatik Master'} semesterNmbr={2} fontSizeTop={"200%"} fontSizeBottom={"65%"} gridColStart={2} gridColEnd={10} gridRowStart={132} gridRowEnd={140}/>
          ...
          <NameTag name={'Simon'} fieldOfStudy={'Mathematik Bachelor'} semesterNmbr={0} fontSizeTop={"170%"} fontSizeBottom={"60%"} gridColStart={16} gridColEnd={23} gridRowStart={55} gridRowEnd={60}/>
          ...
          <NameTag name={'Simon'} fieldOfStudy={'Technomathematik Master'} semesterNmbr={1} fontSizeTop={"130%"} fontSizeBottom={"60%"} gridColStart={42} gridColEnd={49} gridRowStart={60} gridRowEnd={65}/>
          ...
          <NameTag name={'Stefan'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={5} fontSizeTop={"130%"} fontSizeBottom={"50%"} gridColStart={25} gridColEnd={33} gridRowStart={140} gridRowEnd={145}/>
          ...
          <NameTag name={'Stefan'} fieldOfStudy={'Pfeffifee Bachelor'} semesterNmbr={7} fontSizeTop={"150%"} fontSizeBottom={"60%"} gridColStart={5} gridColEnd={15} gridRowStart={154} gridRowEnd={158}/>

          <ImageFrame src="/crew/crewmates_mid_res/ville.jpg" frameSize="10px" frameStyle="frame2" gridColStart={65} gridColEnd={73} gridRowStart={62} gridRowEnd={70}/>
          <NameTag name={'Ville'} fieldOfStudy={'Police Service Bachelor 🚓'} semesterNmbr={8} fontSizeTop={"130%"} fontSizeBottom={"50%"} gridColStart={68} gridColEnd={75} gridRowStart={66} gridRowEnd={70}/>
          ...
          <NameTag name={'Yannik'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={9} fontSizeTop={"130%"} fontSizeBottom={"50%"} gridColStart={74} gridColEnd={80} gridRowStart={38} gridRowEnd={42}/>
          ...
          <NameTag name={'Anja'} fieldOfStudy={'Informatik Master'} semesterNmbr={5} fontSizeTop={"130%"} fontSizeBottom={"50%"} gridColStart={74} gridColEnd={80} gridRowStart={135} gridRowEnd={139}/>
          ...
          <NameTag name={'David'} fieldOfStudy={'Informatik Master'} semesterNmbr={4} fontSizeTop={"130%"} fontSizeBottom={"50%"} gridColStart={74} gridColEnd={80} gridRowStart={135} gridRowEnd={139}/>

          <ImageFrame src="/crew/crewmates_mid_res/pirate.jpg" frameSize="10px" frameStyle="frame2" gridColStart={75} gridColEnd={85} gridRowStart={130} gridRowEnd={138}/> 
          <NameTag name={'Jan'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={9} fontSizeTop={"130%"} fontSizeBottom={"50%"} gridColStart={74} gridColEnd={80} gridRowStart={135} gridRowEnd={139}/>
          ...
          <NameTag name={'Manuel'} fieldOfStudy={'Informatik Master'} semesterNmbr={1} fontSizeTop={"130%"} fontSizeBottom={"50%"} gridColStart={74} gridColEnd={80} gridRowStart={135} gridRowEnd={139}/>
          ...
          <NameTag name={'Marco'} fieldOfStudy={'Informatik Master'} semesterNmbr={2} fontSizeTop={"130%"} fontSizeBottom={"50%"} gridColStart={36} gridColEnd={43} gridRowStart={96} gridRowEnd={100}/>

          <ImageFrame src="/crew/crewmates_mid_res/pirate.jpg" frameSize="10px" frameStyle="frame2" gridColStart={53} gridColEnd={60} gridRowStart={104} gridRowEnd={110}/> 
          <NameTag name={'Maurice'} fieldOfStudy={'Informatik Bachelor'} semesterNmbr={7} fontSizeTop={"130%"} fontSizeBottom={"50%"} gridColStart={55} gridColEnd={63} gridRowStart={106} gridRowEnd={110}/>
